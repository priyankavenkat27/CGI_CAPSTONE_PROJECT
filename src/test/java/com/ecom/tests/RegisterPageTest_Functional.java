...
import com.ecom.Pages.RegisterPageMn;
...
public class RegisterPageTest_Functional extends BaseTest {
    ...
    RegisterPageMn signupPage;
    ExtentTest test;
    
    @BeforeMethod
    public void setUpPage() {
        signupPage = new RegisterPageMn(driver);
    }
    ...
    public void verifyInvalidName(String invalidname, String email) throws IOException {
        ...
        Assert.assertFalse(signupPage.navigatetoCreateAccount(), "Enter Account Information");
        test.pass("Able to fill the name field");
        test.fail("System not blocked signup with invalid name");
